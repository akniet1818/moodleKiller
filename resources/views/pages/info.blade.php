    ...
    <div style="margin: 30px;">
        ...
        <div class="row " style="  display: flex;
            ...
            <div class="col-5 float-right">
                <fieldset class="px-2 py-2 bg-body mb-5">
                    <div id="user_details">
                        <div class="row d-flex text-center">
                            ...
                            <div class="col-8 pt-2">
                                <ul class="list-group list-group-flush">
                                    <li class="list-group-item d-flex"><a href="/profile/{{$name1}}">{{$fullname1}}</a></li>
                ...
                <fieldset class="px-2 py-2 bg-body mb-5">
                    <div id="user_details">
                        <div class="row d-flex text-center">
                            ...
                            <div class="col-8 pt-2">
                                <ul class="list-group list-group-flush">
                                    <li class="list-group-item d-flex"><a href="/profile/{{$name2}}">{{$fullname2}}</a></li>
                ...
                <fieldset class="px-2 py-2 bg-body mb-5">
                    <div id="user_details">
                        <div class="row d-flex text-center">
                            ...
                            <div class="col-8 pt-2">
                                <ul class="list-group list-group-flush">
                                    <li class="list-group-item d-flex"><a href="/profile/{{$name3}}">{{$fullname3}}</a></li>
